...
Now we can analyze our data from Salesforce. For instance, let's compare the two campaigns we have to see which one performed better the last 100 days. 
