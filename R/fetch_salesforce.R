#' fetch_salesforce
#' A function to fetch Amazon Ads data from the windsor.ai API
#'
...
#' @examples
#' \dontrun{
#' my_salesforce_data <- fetch_salesforce(api_key = "your api key",
...
fetch_salesforce <-
  function(api_key,
    ...
    json_data <- jsonlite::fromJSON(
      paste0(
        "https://connectors.windsor.ai/salesforce?api_key=",
        api_key,
        "&fields=",
